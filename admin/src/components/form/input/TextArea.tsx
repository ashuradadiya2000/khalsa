...
const TextArea: React.FC<TextareaProps> = ({ placeholder = "Enter your message", name, rows = 3, value = "", onChange, className = "", disabled = false, error = false, hint = "", }) => {
  ...
  let textareaClasses = `align-middle	w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs focus:outline-hidden ${className} `;
